...
% problem_set = 1:72;
 problem_set =1:18;% [5:9 14:18 23:27 32:36 41:45 50:54 59:63 64:72];
% set parameters
...
for index=1:18  %np
    ...
    for repeats = 1:5
        ...
        % end
         [T1,NFF1,NI1,G1] = IDFPM(Num,'STTCGPM',1,2,x0,para1); % acceleration
        [T2,NFF2,NI2,G2] = IDFPM(Num,'GITDFPA',3,4,x0,para2);
        % [T3,NFF3,NI3,G3] = DFPM(Num,'FITTCGPM-DY',2,1,x0,para2);
        % [T4,NFF4,NI4,G4] = DFPM(Num,'IHCGPM',2,1,x0,para2);
...
legend('STTCGPM','GITDFPA','Location','southeast');
% %subplot(2,2,2);
figure(2);
perf(F,'logplot');
