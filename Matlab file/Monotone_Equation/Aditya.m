...
% set parameters for STTCGPM (Proposed method)
...
% set parameters for FITTCGPM-PRP and FITTCGPM-DY as per there paper
...
% set parameters for IMSMNE as per in paper
